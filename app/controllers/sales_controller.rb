class SalesController < ApplicationController
  ...
  before_action :set_client_options, only: %i[show new create edit update]
  before_action :set_product_options, only: %i[show new create edit update]
  ...
  private
    def set_client_options
      @client_options = Client.all.pluck(:fullname, :id)
    end
    def set_product_options
      @product_options = Product.all.pluck(:stuff, :id)
    end
